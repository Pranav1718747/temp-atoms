...
exports.IrrigationOptimizationModel = void 0;
/**
...
class QLearningAgent {
    ...
    calculateReward(state, action, nextState) {
        ...
        if (nextState.moisture > 80)
            reward -= (nextState.moisture - 80) * 0.5;
        if (nextState.moisture < 30)
            reward -= (30 - nextState.moisture) * 0.3;
...
class IrrigationOptimizationModel {
    ...
    extractFeatures(irrigationData) {
    ...
    generateRecommendation(irrigationData, waterDemand, action) {
    ...
    calculateEfficiency(method, soilType) {
        ...
        const base = baseEfficiency[method] || 0.75;
        const multiplier = soilMultiplier[soilType] || 1.0;
        return Math.min(0.95, base * multiplier);
    }
}
exports.IrrigationOptimizationModel = IrrigationOptimizationModel;
//# sourceMappingURL=irrigation-optimizer.js.map