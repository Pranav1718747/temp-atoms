...
exports.default = exports.PestDiseasePredictor = void 0;
/**
...
class DecisionTree {
    ...
    getFeatureImportance(featureIndex) {
    ...
    buildTree(features, labels, depth) {
        ...
        const { leftFeatures, leftLabels, rightFeatures, rightLabels } = this.splitData(features, labels, bestSplit.featureIndex, bestSplit.threshold);
...
class SimpleNaiveBayes {
    constructor() {
        this.classProbabilities = new Map();
...
class PestDiseasePredictor {
    ...
    async predictPestRisk(environmentalData) {
    ...
    async predictDiseaseRisk(environmentalData) {
        if (!this.isInitialized) {
            await this.initialize();
        }
    ...
    identifyLikelyPests(features, riskScore) {
    ...
    identifyLikelyDiseases(features, riskScore) {
    ...
    generatePestRecommendations(riskScore, features) {
    ...
    generateDiseaseRecommendations(riskScore, features) {
        const recommendations = [];
        if (riskScore > 0.6) {
...
exports.PestDiseasePredictor = PestDiseasePredictor;
exports.default = PestDiseasePredictor;
//# sourceMappingURL=pest-disease-predictor.js.map